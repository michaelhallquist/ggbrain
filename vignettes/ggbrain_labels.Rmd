...
gg_obj <- gg_base +
  geom_outline(definition = "atlas", name = "Yeo 7 Assignment",
               mapping = aes(outline = network), outline_scale = scale_fill_manual(values=yeo7), show_legend = TRUE) +
  geom_brain(definition = "DAN Region := atlas[atlas.network == 'DorsAttn']", mapping=aes(fill=CA_ML_18_MNI), show_legend = TRUE)
